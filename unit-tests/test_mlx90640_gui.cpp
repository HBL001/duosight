/**
 * @file test_mlx90640_read_out_on_gui.cpp
 * @brief Test that Wayland is set up to receive data from userspace, and the 
 * i2c interface can read the MLX device and plop the data on the screen
 *
...
int main(int argc, char *argv[]) {
    ...
    window.setWindowTitle("MLX90640 Thermal Info (Test)");
